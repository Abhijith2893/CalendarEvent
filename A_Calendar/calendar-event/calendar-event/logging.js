...
//$(element).trigger('log', ['name', {'sucess': suc, key2: val2}]);
...
function sendNetworkLog(
    ...
    state,
    version) {
  var formid = "1JY_xX2xE6NFSstbZ-RRsf1L-jR9-1df4Rc8GEc_6z80";
  var data = {
    "entry.2014997920": uid,
    "entry.1007722496": time,
    "entry.2039173699": name,
    "entry.826723296": target,
    "entry.847974207": info,
    "entry.647757729": state,
    "entry.964449646": version
  };
  var params = [];
  for (key in data) {
